...
INSERT INTO `facturapp`.`users` (username, password, name, lastname, email, created_at, active) VALUES ('demo','$2a$04$tJi21NZfSLBkJ6vfLHJB6eq8Et9zud.6KhbhclVLnR5qX0DhA3xBK','Demo','APP','demo@gmail.com',NOW(),1);
